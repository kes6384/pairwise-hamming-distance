...
#define FMIX32(h) h^=h>>16; h*=0x85ebca6b; h^=h>>13; h*=0xc2b2ae35; h^=h>>16;
    ...
    for (int i = -nblocks; i; i++) {
        ...
        k1 *= c1; k1  = ROTL322(k1,15); k1 *= c2; h1 ^= k1;
        h1 = ROTL322(h1,19); h1 += h2; h1 = h1*5+0x561ccd1b;
        k2 *= c2; k2  = ROTL322(k2,16); k2 *= c3; h2 ^= k2;
        h2 = ROTL322(h2,17); h2 += h3; h2 = h2*5+0x0bcaa747;
        k3 *= c3; k3  = ROTL322(k3,17); k3 *= c4; h3 ^= k3;
        h3 = ROTL322(h3,15); h3 += h4; h3 = h3*5+0x96cd1c35;
        k4 *= c4; k4  = ROTL322(k4,18); k4 *= c1; h4 ^= k4;
        h4 = ROTL322(h4,13); h4 += h1; h4 = h4*5+0x32ac3b17;
    }
...
uint64_t hashmap_murmur(const void *data, uint64_t seed0,
    uint64_t seed1)
{
    (void)seed1;
